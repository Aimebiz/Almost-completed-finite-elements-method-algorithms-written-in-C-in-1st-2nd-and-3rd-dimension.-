...
point_d2	pt(0, 0);
pt.abscisse() == (*summit_address(summits_file, summits_memory, summits_memory_descriptor, 3*nbredelements, p)).abscisse();
pt.ordonnee() == (*summit_address(summits_file, summits_memory, summits_memory_descriptor, 3*nbredelements, p)).ordonnee();
...
cout<<pt.ordonnee()<<"\n";
	...
	else if (pt.abscisse() == (*local_point_sender(elements_file, elements_memory, elements_memory_descriptor, nbredelements, e, 1)).abscisse() && pt.ordonnee() == (*local_point_sender(elements_file, elements_memory, elements_memory_descriptor, nbredelements, e, 2)).ordonnee())
	{
		return 2;
	}

	else if (pt.abscisse() == (*local_point_sender(elements_file, elements_memory, elements_memory_descriptor, nbredelements, e, 1)).abscisse() && pt.ordonnee() == (*local_point_sender(elements_file, elements_memory, elements_memory_descriptor, nbredelements, e, 3)).ordonnee())
	{
		return 3;
	}
